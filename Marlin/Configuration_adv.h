 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS     102 // (°C)
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.36 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.36        // (mm) Compression length applying to all extruders
  #endif
